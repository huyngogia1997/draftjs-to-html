(function(global, factory, define) {
  ...
  function addStylePropertyMarkup(styles, text) {
    console.log("addStylePropertyMarkup",styles, text);
    if (
      styles &&
      ...
      console.log("   styles.HIGHLIGHT",styles.HIGHLIGHT);
      if (styles.HIGHLIGHT) {
  ...
  */
  ...
  function getSectionMarkup(block, entityMap, section, customEntityTransform) {
    ...
    inlineStyleSections.forEach(function(styleSection) {
      ...
      console.log("entityInlineMarkup.push(getInlineStyleSectionMarkup(block, styleSection))",entityInlineMarkup);
    })
