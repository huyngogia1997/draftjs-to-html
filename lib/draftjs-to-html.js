(function(global, factory, define) {
  ...
  function getStyleArrayForBlock(block) {
    ...
    var inlineStyles = {
      ...
      HIGHLIGHT: new Array(text.length),
      length: text.length
    }
  ...
  function addStylePropertyMarkup(styles, text) {
    if (
      styles &&
      (styles.COLOR || styles.BGCOLOR || styles.FONTSIZE || styles.FONTFAMILY || styles.HIGHLIGHT)
    ) {
      ...
      if (styles.HIGHLIGHT) {
        styleString += 'stroke-dashoffset: 0;';
      }
  ...
  */
  ...
  function getSectionMarkup(block, entityMap, section, customEntityTransform) {
    console.log("version1: getSectionMarkup(",block, entityMap, section, customEntityTransform,")")
    var entityInlineMarkup = []

    var inlineStyleSections = getInlineStyleSections(
      block,
      ['COLOR', 'BGCOLOR', 'FONTSIZE', 'FONTFAMILY', 'HIGHLIGHT'],
      section.start,
      section.end
    )
    inlineStyleSections.forEach(function(styleSection) {
      console.log("version1: getSectionMarkup) foreach",entityInlineMarkup);
  ...
  function getBlockMarkup(
    ...
    console.log("Version 1: getBlockMarkup(",    block,
    entityMap,
    hashtagConfig,
    directional,
    customEntityTransform,")");
    ...
    if (isAtomicEntityBlock(block)) {
      ...
      if (blockTag) {
        console.log("Version 1: !isAtomicEntityBlock if");
